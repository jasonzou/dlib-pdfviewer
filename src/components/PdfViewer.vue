...
<template>
  <div ref="container" style="position: relative; display: block; overflow: hidden;">
    <canvas ref="pdfcanvas" dir="ltr" style="display: block" role="main" />
    <TextLayer v-show="textLayer" :page="PageProxy as PDFPageProxy" :viewport="InternalViewport" />
    <AnnotationLayer v-show="annotationLayer" :page="PageProxy as PDFPageProxy" :viewport="InternalViewport"
      :document="DocumentProxy as PDFDocumentProxy" :filter="annotationsFilter!" :map="annotationsMap"
